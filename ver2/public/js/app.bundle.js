...
(function () {
  ...
  var clearBtn = document.getElementById('btn-removeCompletedTodos');
  var toggleCompleted = document.querySelector('#chk-allComplete');
  var toggleTab = document.querySelector('.nav-pills');
  ...
  var render = function render() {
    todoList.innerHTML = '';
    filterStatus().forEach(function (todo) {
  ...
  var addTodos = function addTodos() {
    ...
    if (!todos || !todos.length) {
      ...
      todo = { id: getId(), content: content, completed: false };
    }
  ...
  var removeTodo = function removeTodo(id) {
    _axios2.default.delete('/todos/id/' + id).then(function (res) {
      console.log('[DELETE]\n', res.data);
      getTodos();
    }).catch(function (err) {
      return console.log(err.response);
  ...
  var toggleTodoComplete = function toggleTodoComplete(id) {
    ...
    _axios2.default.patch('/todos/' + id, { completed: !completed }).then(function (res) {
      console.log('[TOGGLE]\n', res.data);
      getTodos();
    }).catch(function (err) {
      return console.log(err.response);
  ...
  var toggleAll = function toggleAll(completed) {
    _axios2.default.patch('/todos', completed).then(function (res) {
  ...
  toggleCompleted.addEventListener('click', function (e) {
